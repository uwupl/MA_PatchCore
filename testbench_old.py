...
if __name__ == '__main__':
    ...
    model.group_id = this_run_id + 'default_RN18_4'
    ...
    model.group_id = this_run_id + 'layer_cut_RN18_4'
    model.pooling_strategy = 'default'
    for k, cat in enumerate(cats):
        model.category = cat
        print('\n\n', cat, '\n\n')
    ...
    ##################################################################
    model = PatchCore(args=args)
    model.group_id = this_run_id + 'layer_cut_adapted_pooling_RN18_4'
    ...
    ##################################################################
    model = PatchCore(args=args)
    model.group_id = this_run_id + 'layer_cut_adapted_pooling_only_2nd_layer_RN18_4'
    model.pooling_strategy = 'first_trial'
    ...
    ##################################################################
    model = PatchCore(args=args)
    model.group_id = this_run_id + 'layer_cut_adapted_pooling_only_2nd_layer_normalized_features_RN18_4'
    model.pooling_strategy = 'first_trial'
    model.layers_needed = [2]
    ...
    ##################################################################
    model = PatchCore(args=args)
    model.group_id = this_run_id + 'layer_cut_adapted_pooling_only_2nd_layer_normalized_features_reduce_via_std_50_RN18_4'
    model.pooling_strategy = 'first_trial'
    model.layers_needed = [2]
    model.normalize = True
    ...
    for k, cat in enumerate(cats):
            ...
            if cat == 'own':
                ...
                trainer.test(model) 
    ##################################################################
    model.group_id = this_run_id + 'layer_cut_adapted_pooling_only_2nd_layer_normalized_features_reduce_via_entropy_50_RN18_4'
    model.pooling_strategy = 'first_trial'
    model.layers_needed = [2]
    model.normalize = True
